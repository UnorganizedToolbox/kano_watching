    ...
    <div className="flex-1 flex justify-center items-center h-screen bg-slate-50 dark:bg-darkbg-primary py-8">
      <div className="card-glass bg-white/40 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 p-8 rounded-2xl shadow-xl w-full max-w-sm">
        ...
        <form action={signup} className="flex flex-col gap-4">
          ...
          <div>
            <label className="block text-xs font-bold text-slate-500 mb-1" htmlFor="organization_id">所属団体ID（個人の場合は空欄でOK）</label>
            <input className="w-full px-3 py-2 border border-slate-300 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500 bg-white/60 dark:bg-darkbg-secondary/60 text-slate-900 dark:text-white" id="organization_id" name="organization_id" type="text" placeholder="所属する教師から伝えられたIDを入力" />
          </div>
          <div>
