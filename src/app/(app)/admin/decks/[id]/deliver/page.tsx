...
export default async function DeliverDeckPage(props: { params: Promise<{ id: string }> }) {
    ...
    <section className="flex-1 flex flex-col gap-6 max-w-[700px] mx-auto w-full px-6 pt-2 pb-6">
      <div className="flex items-center gap-4 mb-2">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">デッキ「{deck.title}」を配信します。</p>
        </div>
      </div>
